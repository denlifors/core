<section class="dash__promo">
    ...
    <div class="dash__promoRight">
        <img class="dash__promoImg" src="<?php echo $assetsImg; ?>/dom.png" alt="" />
    </div>
    <img class="dash__promoObj dash__promoObj--a" src="<?php echo $assetsImg; ?>/derevannyi-brelok-na-belom-Photoroom.png" alt="" />
    <img class="dash__promoObj dash__promoObj--b" src="<?php echo $assetsImg; ?>/2669627_1751-Photoroom.png" alt="" />
</section>

<section class="dash__cards2">
    <article class="dash__card dash__card--pink">
        <img class="dash__cardVector" src="<?php echo $assetsImg; ?>/icons/vector.svg" alt="" />
        ...
        <div class="dash__cardBody">
            ...
            <div class="dash__cardMetric">
                ...
                <div class="dash__cardMetricValue dash__cardMetricValue--sm">0</div>
            </div>
        </div>
        <div class="dash__cardActions">
            <a class="dash__action" href="#">
                <img src="<?php echo $assetsImg; ?>/icons/add-circle.svg" alt="" />
                <span>Пополнить</span>
            </a>
            <span class="dash__actionSep"></span>
            <a class="dash__action" href="#">
                <img src="<?php echo $assetsImg; ?>/icons/card-send.svg" alt="" />
                <span>Вывести</span>
            </a>
            <span class="dash__actionSep"></span>
            <a class="dash__action" href="#">
...
<section class="dash__stats">
    <div class="dash__statsHead">
        <div class="dash__statsTitle">Полученные бонусы:</div>
        <div class="dash__statsRange">за текущий период</div>
